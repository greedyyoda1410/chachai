-- Populate Dummy Orders for Past Week
  ...
  FOR days_ago IN 0..6 LOOP
    ...
    BEGIN
      ...
      FOR i IN 1..num_orders LOOP
        ...
        order_time := (order_date + (hour_offset || ' hours')::INTERVAL);
